...
| O39 | Does the absorption preset control earn its place? | P2 | open | @Review | Ratified 2026-09-09 that the three presets ship in order to be TESTED. Measured: at 60 minutes all three return an identical shape, at 120 the spread is two focus minutes, at 180 it is 120 against 150 against 102. Arithmetic cannot say whether three hours feels better at 150 focus minutes or 102 — only use can. Without this row the control survives by default rather than by evidence, which is how surface accumulates. | |
